# Getting Started
Thank you for your interest in contributing to `iotyper-lint`!  
...
`iotyper-lint` is a reminder tool designed to eliminate TODO comments and foster a better codebase.  
...
To develop `iotyper-lint`, you will need to install Go toolchain.  
There are no tools that need to be installed other than `go`.  
If you want to test with golangci-lint, you need to build a custom binary by running `golangci-lint custom`.
